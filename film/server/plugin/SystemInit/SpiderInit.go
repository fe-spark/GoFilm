...
func FilmSourceInit() {
	...
	var l []system.FilmSource = []system.FilmSource{
		{Id: util.GenerateSalt(), Name: "HD(LZ)", Uri: `https://cj.lziapi.com/api.php/provide/vod/`, ResultModel: system.JsonResult, Grade: system.MasterCollect, SyncPictures: false, CollectType: system.CollectVideo, State: false},
